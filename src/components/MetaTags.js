        ...
        <Fragment>
            {
                props.profile && (
                    <Helmet>
                        ...
                        <meta itemprop="name" content={`MhankBarBar Portfolio`} />
